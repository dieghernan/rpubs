...
author: 
  - "Diego Hernangómez"
date: '2021-11-25 (updated 2026-07-04)'
output:
...
esp_gdam <- gadm("ESP", level = 0, path = ".") |> sf::st_as_sf()
...
munic <- esp_get_munic(region = "Segovia") |>
  ...
  left_join(mapSpain::pobmun25, by = c("cpro", "cmun"))
